...
This project demonstrates practical experience in **Java Full Stack Development** using **Spring Boot**, **Angular**, and **MySQL**.
...
- Component-based architecture in Angular frontend
